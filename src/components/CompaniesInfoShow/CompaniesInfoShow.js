...
export default function SimplePaper({functionBack,companyName,companyDescription,companyImg,companyField,companyAdress,companyMail,companyTelephone,companyCity,companyCountrey,companyEmployees,companyJobs,companyEstablishTime,companyTax}) {
  const classes = useStyles();

  return (
    <>
      <Fab className={classes.backButton} color="secondary" aria-label="back" onClick={functionBack}>
        <ArrowBackIcon />
      </Fab>
      <div className='mainContainerppp'>
      	<div className={classes.paperCont}>
      		<img src={companyImg} className='avatarppp'>
      ...
      <div className='detailInfoppp'>
      	<div className='infoppp'>
	      	...
	      	<div>
	     	 	...
	     	 	<span>Address: {companyAdress}, {companyCity} {companyCountrey} , {companyTax}</span>
	      	</div>
	      	<div>
